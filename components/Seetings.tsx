...
const Seetings = () => {
  return (
    <section className="bg-bgWhiteColor h-fit w-[20%] px-3 py-4 rounded-lg">
      <h2 className="text-center mb-6 text-lg font-semibold">Seetings</h2>

      <main className="flex flex-col gap-3 ">
        <div className="flex items-center gap-4 bg-bgColor text-textGrayColor px-4 py-2 rounded-md">
          <IoSettingsSharp />
        ...
        <div className="flex items-center gap-4 bg-bgColor text-textGrayColor px-4 py-2 rounded-md relative">
