        ...
        <div
          ...
          className={` ${
            showCategories
              ...
              : "absolute left-[-700px] lg:static lg:block lg:col-span-4 xl:col-span-3 2xl:col-span-2"
          }`}
        >
          <Categories />
        </div>

        <div className="col-span-full lg:col-span-6 xl:col-span-7 2xl:col-span-6">
          <Dua />
        </div>
